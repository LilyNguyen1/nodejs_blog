module.exports = {
    multipleMongooseToObject: function(mongooseArrays) {
        ...
        //case 1
        //This ở đây là mỗi một document trong mongo, trong model của mongo sẽ trả lại cũng là 1 object nhưng là object constructor(mỗi object chính là document) này được khởi tạo từ object constructor, no có nhiều function, Prototype phức tạp hơn, mà mỗi name, desc không phải là con cấp 1 trực tiếp của this, vậy nên không thể chọc trực tiếp vào được.
        // object literal là 1 object đơn giản
